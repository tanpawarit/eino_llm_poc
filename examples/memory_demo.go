...
func demoMemorySystem() {
	...
	fmt.Println("พิมพ์ /help เพื่อดูคำสั่ง")
	fmt.Println()
	...
	for {
		...
		case "/code":
			...
			sessionManager.GetOrCreateSession("code", 
		...
		case "/chat":
			...
			sessionManager.GetOrCreateSession("chat", 
		...
		default:
			fmt.Println("Unknown command. Type /help for commands or /quit to exit.\n")
		}
	}

...
require (
	...
	github.com/cloudwego/eino-examples v0.0.0-20250811030736-05568cd0095f
	github.com/cloudwego/eino-ext/components/model/ark v0.1.20
	github.com/cloudwego/eino-ext/components/model/deepseek v0.0.0-20250820120452-cb4c949a1d4c
